...
const FeaturedPosts = ({ title, subtitle }: Props) => (
            ...
            <div className="flex-1">
              ...
              <a href="#" className="block">
                ...
                <p className="mt-3 text-base leading-6 text-gray-500">
                  Tests unitaires, fonctionnels ou d'intégration, pas facile de
                  s'y retrouver. Voici l'essentiel à savoir pour bien comprendre
                  la différence entre ces types de tests
                </p>
              </a>
            </div>
