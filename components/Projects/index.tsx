...
const Projects = ({ heading, title, subtitle, projects, id }: Props) => (
  <div className="bg-gray-900 sm:pt-16">
    <div
      id={id}
      className="max-w-xl md:max-w-screen-xl mx-auto pt-12 sm:pt-16 lg:pt-24 px-4 sm:px-6 lg:px-8"
    >
      ...
      <div className="mt-8 pb-12 sm:mt-12 lg:mt-16 md:grid md:grid-cols-2 md:gap-5">
