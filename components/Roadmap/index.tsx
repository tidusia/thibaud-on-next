    ...
    >
      <div className="pb-16">
        ...
        <p className="mt-5 mb-8 max-w-3xl text-xl text-gray-500">
          ...
          pu obtenir avec le temps, et de retracer l'origine de ces compétences.
          <br className="mb-4" />
          ...
          (souvent plusieurs fois), intégrée et mis en pratique.
        </p>
        <Link href={ROUTES.contact.href}>
          <a className="w-full bg-blue-600 border border-transparent rounded-md py-3 px-5 inline-flex items-center justify-center text-base font-medium text-white hover:bg-blue-700 sm:mt-10 sm:w-auto xl:mt-0">
